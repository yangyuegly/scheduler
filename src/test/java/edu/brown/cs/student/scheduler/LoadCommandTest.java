...
//  @Test
  public void testLoadNoConflicts() {
    ...
    String[] a = new String[] {"attendee1", "event1"};
    String[] b = new String[] {"attendee2", "event2"};
    String[] c = new String[] {"attendee3", "event3"};
    input.add(a);
    input.add(b);
    input.add(c);
    lc.execute(input, convention);

    List<Event> events = DatabaseUtility.getEventsFromConventionID("testConvention");
...
//  @Test
  public void testLoadConflicts() {
    ...
    List<String[]> input = new ArrayList<String[]>();
    String[] a = new String[] {"attendee1", "event1"};
    String[] b = new String[] {"attendee2", "event2", "event3"};
    input.add(a);
    input.add(b);
    lc.execute(input, convention);
