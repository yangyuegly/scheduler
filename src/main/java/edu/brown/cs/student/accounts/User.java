...
public class User {
   ...
   *
   * email - a String, which represents the user's email conventions - a List of
   * conventions, which represents the conventions that this user is managing
   */
   ...
   *
   * @return a List of conventions, which represents the conventions that this
   *         user is managing
   */
